  ...
  return (
    <section className="cart font-[Calibri]">
      ...
      <div className="text-center pt-7 mt-7">
        <h2 className="font-bold text-[25px]">Get In Touch With Us</h2>
        <p className="text-[#9F9F9F] text-[16px] px-4">
          For More Information About Our Product & Services.
          <br /> Please Feel Free To Drop Us An Email. Our Staff Always Be There{" "}
          <br /> To Help You Out. Do Not Hesitate!
        </p>
      </div>
      ...
      <div className="flex flex-col md:flex-row text-start font-[Calibri] mt-10 px-4">
            ...
            <div className="gap-5">
              ...
              <div className="pl-10 w-full ">
                ...
                <p className="text-[16px] font-semibold">
                  30, Alhaji Amoo Street Ojota, Lagos,
                  <br /> Nigeria
                </p>
              </div>
            </div>
        ...
        <div className="rounded font-[Calibri] w-full md:w-[50%] mx-auto h-full py-6 mb-2 gap-20 overflow-y-auto  top-20">
          ...
          <div className="mb-5">
              <label className="text-[14px] font-bold">Your Name</label> <br />
              <input
                type="text"
                required  
          ...
          <div className="mb-5">
            <label className="text-[14px] font-bold">Email Address</label> <br />
            <input
              type="email"
              required
          ...
          <div className="mb-5">
            <label className="text-[14px] font-bold">Subject </label> <br />
            <input
              type="text"
              required
          ...
          <div className="mb-5">
            <label className="text-[14px] font-bold">Message </label> <br />
            <textarea
              className="border-2 p-4 w-[100%]  lg:w-[40vw] rounded-lg border-gray-300"
          ...
          <div className="">
            <button className="bg-[#B88E2F] px-14 py-2 text-white  rounded font-[Calibri]">
              Submit
            </button>
          </div>
        </div>
